...
ENT.Model = "models/zgrad/stielhandgranate24/stielhandgranate24.mdl"
ENT.SpoonScale = 2
...
if SERVER then
    ...
    function ENT:Detonate()
        ...
        JMod.FragSplosion(self, SelfPos + Vector(0, 0, 20), 1200, 400, 1000, self:GetOwner() or game.GetWorld())
        self:Remove()
    end
elseif CLIENT then
