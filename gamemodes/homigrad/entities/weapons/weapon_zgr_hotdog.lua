SWEP.PrintName = "The Hotdog Bat"
SWEP.Author = "Zgrad"
SWEP.Instructions = "Made to kill them pickles."
SWEP.Category = "HOMO"
SWEP.IconOverride = "materials/items_icons/hotdogicon.png"
...
SWEP.ViewModel = "models/food/hotdog.mdl"
...
if CLIENT then
    ...
    function SWEP:DrawWorldModel()
        ...
        if (IsValid(_Owner)) then
            local offsetVec = Vector(-23, -1, -18)
