...
if CLIENT then
	SWEP.PrintName = language.GetPhrase("Crowbar")
	SWEP.Instructions = language.GetPhrase("I still owe you a beer...")
	SWEP.Category = language.GetPhrase("HL3")
	SWEP.IconOverride = "materials/items_icons/crowbarhl3icon.png"
end
