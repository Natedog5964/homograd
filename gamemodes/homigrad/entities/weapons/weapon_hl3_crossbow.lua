...
if CLIENT then
	SWEP.PrintName = language.GetPhrase("Crossbow")
	SWEP.Author = "Homigrad"
	SWEP.Instructions = language.GetPhrase("A silent but deadly weapon.\nUses crossbow bolts.")
	SWEP.Category = language.GetPhrase("HL3")
	SWEP.IconOverride = "materials/items_icons/crossbowhl3icon.png"
end
